        ...
        <div id="publications">
          ...
          <Accordion type="single" collapsible className="w-full">
            <AccordionItem value="item-1">
              ...
              <AccordionContent>
                <p className="text-sm text-muted-foreground mb-2">
                  ...
                  markets in emerging economies, with a focus on behavioral and
            ...
            <AccordionItem value="item-2">
              ...
              <AccordionContent>
                <p className="text-sm text-muted-foreground mb-2">
                  ...
                  can be effectively implemented in bottom of pyramid markets to
                  create shared value.
                </p>
                <Link href="#" className="text-sm text-primary hover:underline">
            ...
            <AccordionItem value="item-3">
              ...
              <AccordionContent>
                <p className="text-sm text-muted-foreground mb-2">
                  A comprehensive analysis of how traditional retail businesses
                  are navigating digital transformation in the post-pandemic
                  era.
                </p>
                <Link href="#" className="text-sm text-primary hover:underline">
            ...
            <AccordionItem value="item-5">
              <AccordionTrigger>
                &quot;Sustainability Metrics for SMEs (Journal of Small Business
                Management, 2019)&quot;
              </AccordionTrigger>
              <AccordionContent>
                <p className="text-sm text-muted-foreground mb-2">
                  This paper proposes a practical framework for small and medium
                  enterprises to measure and report on sustainability
                  initiatives.
                </p>
                <Link href="#" className="text-sm text-primary hover:underline">
