...
export default function HomePage() {
  ...
  const newsUpdates = [
    ...
    },
    {
     ...
     {
      id: 4,
      title: 'Heartiest congratulations to Prof Anuj Sharma on resuming his role as Head of the Department',
      content:
        '',
    ...
    {
      id: 5,
      title: 'A warm welcome to Amrita Sharma, Deepa yadav, Aman Dhutwani and Rohit as new members of our research group',
      content:
        '',
      lastUpdate: '2026-01-17',
    },
